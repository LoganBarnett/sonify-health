...
/// WATCHDOG_PID in addition to WATCHDOG_USEC so spurious inherited env
/// vars are ignored.  Pinging at half the interval provides a safety
/// margin before systemd declares the service dead.
